...
public class Platinum extends TarjetaCredito{
    ...
    public Platinum(String emisor, long cupo, String numeroTarjeta, Integer cvv, LocalDate fechaVencimiento, long cupo1, String numeroTarjeta1, Integer cvv1, LocalDate fechaVencimiento1) {
